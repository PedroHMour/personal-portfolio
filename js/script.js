...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            menu: "Menu", nav_about: "01. About", nav_expertise: "02. Expertise", nav_projects: "03. Projects", nav_contact: "04. Contact",
            ...
            about_title: "01. About Me", about_p1: "Hello! I'm Pedro, a Python developer passionate about creating solutions that make processes more efficient. My interest in automation started when I realized how much time could be saved by scripting repetitive tasks.", about_p2: "Today, I help businesses by developing custom scripts for web scraping, automating workflows, and integrating with APIs. I'm always eager to learn new technologies and solve challenging problems.", about_p3: "Here are a few technologies I’ve been working with recently:",
            expertise_title: "02. Expertise", expertise_card1_title: "Process Automation", expertise_card1_desc: "Automating repetitive tasks, from filling out forms and generating reports to managing files, saving time and reducing errors.", expertise_card2_title: "Web Scraping & Data Extraction", expertise_card2_desc: "Developing robust scripts to extract valuable data from websites for market analysis, lead generation, or price monitoring.", expertise_card3_title: "API Development & Integration", expertise_card3_desc: "Building and connecting to APIs to make different systems 'talk' to each other, centralizing data and creating seamless workflows.",
            projects_title: "03. Projects", project1_title: "E-commerce Price Monitor", project1_desc: "A script that scrapes prices from multiple online stores for a specific product, and sends an email alert when the price drops below a certain value.",
            contact_title: "04. What's Next?", contact_subtitle: "Get In Touch", contact_desc: "I'm currently open to new opportunities and my inbox is always open. Whether you have a question or just want to say hi, I’ll get back to you!", contact_cta: "Say Hello",
            footer_credit: "Designed & Built by Pedro Henrique", footer_rights: "All rights reserved.",
        },
        pt: {
            menu: "Menu", nav_about: "01. Sobre", nav_expertise: "02. Serviços", nav_projects: "03. Projetos", nav_contact: "04. Contato",
            ...
            about_title: "01. Sobre Mim", about_p1: "Olá! Sou Pedro, um desenvolvedor Python apaixonado por criar soluções que tornam processos mais eficientes. Meu interesse por automação começou quando percebi o quanto tempo poderia ser poupado ao programar tarefas repetitivas.", about_p2: "Hoje, ajudo empresas desenvolvendo scripts personalizados para web scraping, automação de fluxos de trabalho e integração com APIs. Estou sempre ansioso para aprender novas tecnologias e resolver problemas desafiadores.", about_p3: "Aqui estão algumas tecnologias com as quais tenho trabalhado recentemente:",
            expertise_title: "02. Serviços", expertise_card1_title: "Automação de Processos", expertise_card1_desc: "Automatizando tarefas repetitivas, desde o preenchimento de formulários e geração de relatórios até o gerenciamento de arquivos, economizando tempo e reduzindo erros.", expertise_card2_title: "Web Scraping & Extração de Dados", expertise_card2_desc: "Desenvolvendo scripts robustos para extrair dados valiosos de websites para análise de mercado, geração de leads ou monitoramento de preços.", expertise_card3_title: "Desenvolvimento & Integração de APIs", expertise_card3_desc: "Construindo e conectando a APIs para fazer diferentes sistemas 'conversarem' entre si, centralizando dados e criando fluxos de trabalho contínuos.",
            projects_title: "03. Projetos", project1_title: "Monitor de Preços para E-commerce", project1_desc: "Um script que extrai preços de várias lojas online para um produto específico e envia um alerta por e-mail quando o preço cai abaixo de um determinado valor.",
            contact_title: "04. Qual o Próximo Passo?", contact_subtitle: "Entre em Contato", contact_desc: "Estou aberto a novas oportunidades e minha caixa de entrada está sempre aberta. Se você tem uma pergunta ou apenas quer dizer oi, eu retornarei o contato!", contact_cta: "Diga Olá",
            footer_credit: "Projetado & Construído por Pedro Henrique", footer_rights: "Todos os direitos reservados.",
        },
        fr: {
            menu: "Menu", nav_about: "01. À propos", nav_expertise: "02. Expertise", nav_projects: "03. Projets", nav_contact: "04. Contact",
